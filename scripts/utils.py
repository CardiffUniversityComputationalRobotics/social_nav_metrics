...
CSV_FIELDNAMES = [
    ...
    "average_ttc",
    "total_time",
    "people_collision_counter",
    "object_collision_counter",
    "num_nodes",
    "path_irregularity",
    "in_place_rotation",
        ...
        writer.writerow(
            {
                ...
                "average_sei": round(_safe_average(recorder.sei_), 4),
                "average_ttc": round(_safe_average(recorder.ttc_), 4),
                "total_time": round(recorder.total_time_, 4),
                "people_collision_counter": recorder.people_collision_counter_,
                "object_collision_counter": recorder.object_collision_counter_,
